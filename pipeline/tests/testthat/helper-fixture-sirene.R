...
# economie-pipeline-contracts — bascule régionale) : un mini extrait de
...
# plus la tranche d'effectifs en LIBELLÉS ODS (trancheeffectifsetablissement),
# et une colonne leurre (libellecommuneetablissement) que la normalisation
# doit écarter. Le statut administratif est en libellés ODS enrichis
# (« Actif »/« Fermé »), jamais en codes nationaux « A »/« F ».
