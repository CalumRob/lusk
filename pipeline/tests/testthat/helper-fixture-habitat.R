...
# Le jeu de données synthétique du thème Habitat (issue #17) : la même trame
# que le fixture Démographie (4 communes / 2 EPCIs / 2 départements / région)
# étendue aux trois sources Habitat, DANS LA FORME des tables processées que
# construire_donnees_habitat() assemble (les reshape/nettoyages #14/#15/#16
