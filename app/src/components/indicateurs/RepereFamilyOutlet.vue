...
import type { ModeleComposition, ModeleEnsembleComparaison, ModeleProfil, ModeleRelation, ModeleSignature, ModeleTrajectoire } from '@/indicateurs/explorationModel'
...
defineProps<{ dispatch: FamilyDispatch; modele?: ModeleTrajectoire | null; signature?: ModeleSignature | null; profil?: ModeleProfil | null; relation?: ModeleRelation | null; composition?: ModeleComposition | null; ensemble?: ModeleEnsembleComparaison | null }>()
</script>
<template>
  <section class="repere-family-outlet" :data-family="dispatch.family" :data-renderer="dispatch.renderer">
    ...
    <DistributionFamilyRenderer v-else-if="dispatch.family === 'distribution'" :dispatch="dispatch" :signature="signature" :ensemble="ensemble"><slot :dispatch="dispatch" /></DistributionFamilyRenderer>
