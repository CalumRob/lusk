...
const familyDispatch = computed(() => page.value ? dispatchIndicatorFamily(page.value, { facts: facts.value, territories: payload.value.territoires, selected: typeof route.query.territoire === 'string' ? route.query.territoire : undefined, facet: route.query }) : null)
